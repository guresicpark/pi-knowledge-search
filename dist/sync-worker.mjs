...
var KnowledgeIndex = class _KnowledgeIndex {
  ...
  constructor(config2, embedder2) {
    ...
    this.data = {
      ...
      embeddingModel: config2.modelSignature,
      entries: {}
    };
...
${chunkText}`;
  ...
  async hybridSearch(query, limit, signal) {
    ...
    for (const key of candidateKeys) {
      ...
      const path3 = this.absPathFromKey(key);
      if (firstQueryTerm && path3.toLowerCase().includes(firstQueryTerm)) {
